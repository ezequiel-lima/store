...
namespace Store.Tests.Entities
{
    ...
    {
        private readonly Customer _customer = new("João Ezequiel", "ezequiel.lima.br@gmail.com");
        private readonly Product _product = new("Produto 1", 10, true);
        private readonly Discount _discount = new(10, DateTime.Now.AddDays(5));
        private readonly Discount _expiredDiscount = new (10, DateTime.Now.AddDays(-1));
